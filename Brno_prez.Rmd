---
title: "Spatial randomization as an approach to deal with spatially autocorrelated ecological data"
author: "Vojta Barták"
institution: "DSS FES CZU Prague"
email: "bartakv@fzp.czu.cz"
date: "04 2023"
output:
  beamer_presentation:  
    incremental: false  
...
-   Generalized Least Squares (GLS) - geostatistics
-   Autoregressive models (CAR, SAR)
-   Adding coordinates as predictors (e.g. in GAM)
-   Spatial Eigenvector Mapping (SEVM)

## Do these methods work?

![](spatial_models_effectiveness.png){}
...
-   Response simulated as **dependent** on the predictor: $$response = predictor + \alpha \cdot error$$

...
Covariance matrix: $\boldsymbol\Sigma=\begin{pmatrix}Var(X) & Cov(X,Y)\\Cov(X,Y) & Var(Y)\end{pmatrix}$
...
$Y_i=S(x_i)+\epsilon_i$, where $z_i\sim iid, E(\epsilon_i)=0, Var(\epsilon_i)=\tau^2$
